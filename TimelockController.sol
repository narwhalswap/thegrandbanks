...
// File: contracts/interfaces/IGrandFarm.sol
...
contract TimelockController is AccessControl {
    ...
    uint256 public minDelay = 86400; // seconds - to be increased in production
    uint256 public minDelayReduced = 43200; // seconds - to be increased in production

    address payable public devWalletAddress =
        0x18527a351dB2435Fa21Db88cB87d4155188b62b0;
    /**
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        IGrandFarm(_grandfarmAddress).set(_pid, _allocPoint, _withUpdate);
        _afterCall(id);
    }
    ...
    function add(
        ...
        IGrandFarm(_grandfarmAddress).add(0, _want, _withUpdate, _strat,_frySailing,_fryLanding,_isLp); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
